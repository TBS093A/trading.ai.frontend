...
const SyncSection = () => {
  ...
  const { activeSection, exchanges, technical, bulk, activeTasks } = useSelector(
    (state) => state.sync
  );
          ...
          <div className="sync-item">
            ...
            {activeSection === 'exchanges' && (
              <div className="sync-item-content">
                ...
                >
                  {exchanges.loading ? '⟳ Synchronizuję...' : '⟳ Synchronizuj'}
                </button>
              </div>
            )}
          </div>
                  ...
                  <>
                    <div className="bulk-header">
                      <span className="selected-count">
                        Wybrano: {selectedAssetIds.size} / {assets.length}
                      </span>
                      <button className="select-all-btn" onClick={toggleSelectAll}>
                        {selectedAssetIds.size === assets.length ? 'Odznacz wszystkie' : 'Zaznacz wszystkie'}
                      </button>
                    </div>
